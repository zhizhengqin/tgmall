<template><div class="page"><TopBar/><Sidebar/><div class="main"><el-page-header @back="$router.back()"><template #content>ព័ត៌មានហាង</template></el-page-header><p style="margin-top:20px">ទំព័រលម្អិតហាង</p></div></div></template>
