<template><div class="page"><TopBar/><Sidebar/><div class="main"><h1>{{ $t('settings.title') }}</h1><p style="color:#999">{{ $t('settings.placeholder') || 'ការកំណត់ប្រព័ន្ធ (P2 - នឹងអភិវឌ្ឍបន្ត)' }}</p></div></div></template>
