  ...
  <div class="page">
    <div class="main">
      ...
      <el-table :data="items" v-loading="loading" stripe>
        ...
        <el-table-column :label="$t('settings.iconUrl')" width="80">
          <template #default="{row}">
            <img v-if="row.iconUrl" :src="row.iconUrl" class="icon-thumb" />
          </template>
        </el-table-column>
      ...
      <el-dialog v-model="dialogVisible" :title="form.code ? $t('settings.edit') : $t('settings.create')" width="500px">
        <el-form :model="form" label-width="100px">
          ...
          <el-form-item :label="$t('settings.iconUrl')"><el-input v-model="form.iconUrl" /></el-form-item>
...
.icon-thumb{width:32px;height:32px;object-fit:contain}
</style>
